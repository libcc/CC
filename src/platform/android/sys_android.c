...
#define _CC_JAVA_INTERFACE(function)                     _CONCAT1(_CC_JAVA_PREFIX_, CCWidgets, function)

// Java class CCWidgets
JNIEXPORT jstring JNICALL _CC_JAVA_INTERFACE(nativeGetVersion)(JNIEnv *env, jclass cls);
JNIEXPORT void JNICALL _CC_JAVA_INTERFACE(nativeSetupJNI)(JNIEnv *env, jclass cls);
JNIEXPORT void JNICALL _CC_JAVA_INTERFACE(nativeQuit)(JNIEnv *env, jclass cls);
JNIEXPORT void JNICALL _CC_JAVA_INTERFACE(nativePause)(JNIEnv *env, jclass cls);
JNIEXPORT void JNICALL _CC_JAVA_INTERFACE(nativeResume)(JNIEnv *env, jclass cls);
JNIEXPORT void JNICALL _CC_JAVA_INTERFACE(nativePermissionResult)(JNIEnv *env, jclass cls,jint requestCode, jboolean result);
JNIEXPORT void JNICALL _CC_JAVA_INTERFACE(nativeFocusChanged)(JNIEnv *env, jclass cls, jboolean hasFocus);
JNIEXPORT void JNICALL _CC_JAVA_INTERFACE(nativeDropFile)(JNIEnv *env, jclass jcls,jstring filename);
JNIEXPORT void JNICALL _CC_JAVA_INTERFACE(nativeLocaleChanged)(JNIEnv *env, jclass cls);
JNIEXPORT void JNICALL _CC_JAVA_INTERFACE(nativeDarkModeChanged)(JNIEnv *env, jclass cls, jboolean enabled);
JNIEXPORT void JNICALL _CC_JAVA_INTERFACE(nativeClipboardChanged)(JNIEnv *env, jclass jcls);
JNIEXPORT void JNICALL _CC_JAVA_INTERFACE(nativeSetPowerInfo)(JNIEnv *env, jclass jcls, jint plugged, jint charged,jint battery, jint seconds, jint percent);

static JNINativeMethod _jni_native_tab[] = {
    { "nativeGetVersion", "()Ljava/lang/String;", _CC_JAVA_INTERFACE(nativeGetVersion) },
    { "nativeSetupJNI", "()I", _CC_JAVA_INTERFACE(nativeSetupJNI) },
    { "nativeClipboardChanged", "()V", _CC_JAVA_INTERFACE(nativeClipboardChanged) },
    { "nativeLocaleChanged", "()V", _CC_JAVA_INTERFACE(nativeLocaleChanged) },
    { "nativeDarkModeChanged", "(Z)V", _CC_JAVA_INTERFACE(nativeDarkModeChanged) },
    { "nativeDropFile", "(Ljava/lang/String;)V", _CC_JAVA_INTERFACE(nativeDropFile) },
    { "nativeQuit", "()V", _CC_JAVA_INTERFACE(nativeQuit) },
    { "nativePause", "()V", _CC_JAVA_INTERFACE(nativePause) },
    { "nativeResume", "()V", _CC_JAVA_INTERFACE(nativeResume) },
    { "nativeFocusChanged", "(Z)V", _CC_JAVA_INTERFACE(nativeFocusChanged) },
    { "nativePermissionResult", "(IZ)V", _CC_JAVA_INTERFACE(nativePermissionResult) },
    { "nativeSetPowerInfo", "(IIIII)V", _CC_JAVA_INTERFACE(nativeSetPowerInfo)}
};
...
JNIEXPORT void JNICALL _CC_JAVA_INTERFACE(nativeSetupJNI)(JNIEnv *env, jclass cls) {
    ...
    mJNIMainClass = (jclass)((*env)->NewGlobalRef(env, cls));

    midClipboardGetText = (*env)->GetStaticMethodID(env, mJNIMainClass, "clipboardGetText", "()Ljava/lang/String;");
    midClipboardHasText = (*env)->GetStaticMethodID(env, mJNIMainClass, "clipboardHasText", "()Z");
    midClipboardSetText = (*env)->GetStaticMethodID(env, mJNIMainClass, "clipboardSetText", "(Ljava/lang/String;)V");
    midGetContext = (*env)->GetStaticMethodID(env, mJNIMainClass, "getContext", "()Landroid/content/Context;");

    midGetManifestEnvironmentVariables = (*env)->GetStaticMethodID(env, mJNIMainClass, "getManifestEnvironmentVariables", "()Z");

    midIsAndroidTV = (*env)->GetStaticMethodID(env, mJNIMainClass, "isAndroidTV", "()Z");
    midIsChromebook = (*env)->GetStaticMethodID(env, mJNIMainClass, "isChromebook", "()Z");
    midIsDeXMode = (*env)->GetStaticMethodID(env, mJNIMainClass, "isDeXMode", "()Z");
    midIsTablet = (*env)->GetStaticMethodID(env, mJNIMainClass, "isTablet", "()Z");

    midOpenURL = (*env)->GetStaticMethodID(env, mJNIMainClass, "openURL", "(Ljava/lang/String;)Z");
    midRequestPermission = (*env)->GetStaticMethodID(env, mJNIMainClass, "requestPermission", "(Ljava/lang/String;I)V");

    midShowToast = (*env)->GetStaticMethodID(env, mJNIMainClass, "showToast", "(Ljava/lang/String;IIII)Z");
    midSetWindowStyle = (*env)->GetStaticMethodID(env, mJNIMainClass, "setWindowStyle", "(Z)V");
    midSetActivityTitle = (*env)->GetStaticMethodID(env, mJNIMainClass, "setActivityTitle", "(Ljava/lang/String;)Z");
    midGetPreferredLocales = (*env)->GetStaticMethodID(env, mJNIMainClass, "getPreferredLocales", "()Ljava/lang/String;");
    midGetNetworkType = (*env)->GetStaticMethodID(env, mJNIMainClass, "getNetworkType", "()I");
    midOpenFileDescriptor = (*env)->GetStaticMethodID(env, mJNIMainClass, "openFileDescriptor", "(Ljava/lang/String;Ljava/lang/String;)I");

    midRegisterPowerInfo = (*env)->GetStaticMethodID(env, mJNIMainClass, "registerPowerInfo", "()V");
...
JNIEXPORT void JNICALL _CC_JAVA_INTERFACE(nativeLocaleChanged)(
...
// Dark mode
JNIEXPORT void JNICALL _CC_JAVA_INTERFACE(nativeDarkModeChanged)(
...
// Activity ends
JNIEXPORT void JNICALL _CC_JAVA_INTERFACE(nativeQuit)(
    JNIEnv *env, jclass cls) {
    //const char *str;
...
// Pause
JNIEXPORT void JNICALL _CC_JAVA_INTERFACE(nativePause)(
    JNIEnv *env, jclass cls) {
    __android_log_print(ANDROID_LOG_VERBOSE, _CC_ANDROID_TAG_, "nativePause()");
}

// Resume
JNIEXPORT void JNICALL _CC_JAVA_INTERFACE(nativeResume)(
    JNIEnv *env, jclass cls) {
    __android_log_print(ANDROID_LOG_VERBOSE, _CC_ANDROID_TAG_, "nativeResume()");
}

JNIEXPORT void JNICALL _CC_JAVA_INTERFACE(nativeFocusChanged)(
    JNIEnv *env, jclass cls, jboolean hasFocus) {
    __android_log_print(ANDROID_LOG_VERBOSE, _CC_ANDROID_TAG_, "nativeFocusChanged()");
}

JNIEXPORT void JNICALL _CC_JAVA_INTERFACE(nativeSetPowerInfo)(
...
JNIEXPORT jboolean JNICALL _CC_JAVA_INTERFACE(nativeGetHintBoolean)(
    JNIEnv *env, jclass cls,
...
_CC_API_PUBLIC(void) Android_JNI_SetActivityTitle(const tchar_t *title) {
    ...
    (*env)->CallStaticBooleanMethod(env, mJNIMainClass, midSetActivityTitle, jtitle);
    (*env)->DeleteLocalRef(env, jtitle);
}

_CC_API_PUBLIC(void) Android_JNI_SetWindowStyle(bool_t fullscreen) {
    JNIEnv *env = Android_JNI_GetEnv();
    (*env)->CallStaticVoidMethod(env, mJNIMainClass, midSetWindowStyle, fullscreen ? 1 : 0);
}
...
_CC_API_PUBLIC(bool_t) Android_JNI_SetClipboardText(const tchar_t *buf) {
    ...
    (*env)->CallStaticVoidMethod(env, mJNIMainClass, midClipboardSetText, string);
...
_CC_API_PUBLIC(int32_t) Android_JNI_GetClipboardText(tchar_t *buf, size_t buf_length) {
    JNIEnv *env = Android_JNI_GetEnv();
    size_t utf_length = 0;
    jstring string = (*env)->CallStaticObjectMethod(env, mJNIMainClass, midClipboardGetText);
    if (string) {
...
_CC_API_PUBLIC(bool_t) Android_JNI_HasClipboardText(void) {
    JNIEnv *env = Android_JNI_GetEnv();
    return (*env)->CallStaticBooleanMethod(env, mJNIMainClass, midClipboardHasText);
}
...
_CC_API_PUBLIC(void) Android_JNI_GetPowerInfo(int *plugged, int *charged, int *battery, int *seconds, byte_t *percent) {
    ...
    if (!androidPowerInfo.registered) {
        (*env)->CallStaticVoidMethod(env, mJNIMainClass, midRegisterPowerInfo);
...
_CC_API_PUBLIC(int) Android_JNI_GetNetworkType(void) {
    JNIEnv *env = Android_JNI_GetEnv();
    return (*env)->CallStaticIntMethod(env, mJNIMainClass, midGetNetworkType);
}

_CC_API_PUBLIC(bool_t) IsAndroidTablet(void) {
    JNIEnv *env = Android_JNI_GetEnv();
    return (*env)->CallStaticBooleanMethod(env, mJNIMainClass, midIsTablet);
}

_CC_API_PUBLIC(bool_t) IsAndroidTV(void) {
    JNIEnv *env = Android_JNI_GetEnv();
    return (*env)->CallStaticBooleanMethod(env, mJNIMainClass, midIsAndroidTV);
}

_CC_API_PUBLIC(bool_t) IsChromebook(void) {
    JNIEnv *env = Android_JNI_GetEnv();
    return (*env)->CallStaticBooleanMethod(env, mJNIMainClass, midIsChromebook);
}

_CC_API_PUBLIC(bool_t) IsDeXMode(void) {
    JNIEnv *env = Android_JNI_GetEnv();
    return (*env)->CallStaticBooleanMethod(env, mJNIMainClass, midIsDeXMode);
}
...
_CC_API_PUBLIC(void) Android_JNI_GetManifestEnvironmentVariables(void) {
    if (!mJNIMainClass || !midGetManifestEnvironmentVariables) {
    ...
    if (!bHasEnvironmentVariables) {
        JNIEnv *env = Android_JNI_GetEnv();
        bool_t ret = (*env)->CallStaticBooleanMethod(env, mJNIMainClass, midGetManifestEnvironmentVariables);
        if (ret) {
...
JNIEXPORT void JNICALL _CC_JAVA_INTERFACE(nativePermissionResult)(
    JNIEnv *env, jclass cls,
...
_CC_API_PUBLIC(bool_t) Android_JNI_RequestPermission(const tchar_t *permission, RequestAndroidPermissionCallback_t cb, pvoid_t userdata){
    ...
    (*env)->CallStaticVoidMethod(env, mJNIMainClass, midRequestPermission, jpermission, info->request_code);
...
_CC_API_PUBLIC(bool_t) Android_JNI_ShowToast(const tchar_t *message, int duration, int gravity, int xOffset, int yOffset) {
    ...
    result = (*env)->CallStaticBooleanMethod(env, mJNIMainClass, midShowToast, jmessage, duration, gravity, xOffset, yOffset);
...
_CC_API_PUBLIC(int) Android_JNI_OpenFileDescriptor(const tchar_t *uri, const tchar_t *mode) {
    ...
    jint fd = (*env)->CallStaticIntMethod(env, mJNIMainClass, midOpenFileDescriptor, jstringUri, jstringMode);
