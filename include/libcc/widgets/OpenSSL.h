...
_CC_API_WIDGETS(bool_t) _SSL_setup(_cc_OpenSSL_t *ssl,
                                const tchar_t *cert_file,
                                const tchar_t *key_file,
                                const tchar_t *key_password);

_CC_API_WIDGETS(_cc_OpenSSL_t*) _SSL_init(bool_t is_client);
/**/
_CC_API_WIDGETS(void) _SSL_quit(_cc_OpenSSL_t *);
/**/
_CC_API_WIDGETS(_cc_SSL_t*) _SSL_alloc(_cc_OpenSSL_t*);
/**/
_CC_API_WIDGETS(bool_t) _SSL_free(_cc_SSL_t*);
/**/
_CC_API_WIDGETS(_cc_SSL_t*) _SSL_accept(_cc_OpenSSL_t *ctx, _cc_socket_t fd);
/**/
_CC_API_WIDGETS(_cc_SSL_t*) _SSL_connect(_cc_OpenSSL_t *ctx, _cc_socket_t fd);
/**/
_CC_API_WIDGETS(void) _SSL_set_host_name(_cc_SSL_t*, tchar_t*, size_t);
/**/
_CC_API_WIDGETS(uint8_t) _SSL_do_handshake(_cc_SSL_t*);
/**/
_CC_API_WIDGETS(int32_t) _SSL_send(_cc_SSL_t*, const byte_t*, int32_t);
/**/
_CC_API_WIDGETS(int32_t) _SSL_read(_cc_SSL_t*, byte_t*, int32_t);
