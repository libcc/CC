...
/**/
_CC_API_WIDGETS(bool_t) _cc_init_event_timeout(_cc_async_event_t*);

/**/
_CC_API_WIDGETS(_cc_event_t*)
_cc_add_event_timeout(_cc_async_event_t* async, uint32_t timeout, _cc_event_callback_t callback, uintptr_t data);
/**/
_CC_API_WIDGETS(bool_t) _cc_kill_event_timeout(_cc_async_event_t*, _cc_event_t*);
